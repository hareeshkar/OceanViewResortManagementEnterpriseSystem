...
<head>
    ...
    <style>
        .help-card { max-width: 900px; margin: 0 auto; padding: 40px; }
        .help-card h1 { color: var(--primary-dark); border-bottom: 2px solid var(--accent-emerald); padding-bottom: 10px; margin-bottom: 20px; }
        .toc { background: #f8f9fa; padding: 20px; border-radius: 5px; margin-bottom: 30px; border: 1px solid var(--border-cool); }
        .toc h3 { margin-bottom: 10px; font-family: var(--font-heading); }
        .toc ol { margin-left: 20px; }
        .toc a { color: var(--primary-dark); text-decoration: none; font-weight: bold; }
        .toc a:hover { color: var(--accent-emerald); }
        section h2 { color: var(--accent-emerald); margin-top: 30px; margin-bottom: 15px; font-family: var(--font-heading); }
        ...
        <div class="card help-card">
            ...
            <section id="new-booking">
                ...
                <ul>
                    ...
                    <li>Select the <strong>Arrival</strong> and <strong>Departure</strong> dates. The system prevents selecting past dates.</li>
                    <li>Choose a <strong>Room Category</strong>; the system will display available rooms for those dates.</li>
            ...
            <section id="view-invoice">
                ...
                <ul>
                    ...
                    <li>Use your browser's print function (Ctrl + P or Cmd + P) to print the invoice on A4 paper.</li>
                </ul>
            </section>
            ...
            <section id="policies">
                ...
                <ul>
                    <li><strong>Stay Duration:</strong> Calculated as the number of nights between arrival and departure dates.</li>
                    <li><strong>Service Tax:</strong> A mandatory 5% service charge is applied to the room rate.</li>
                    <li><strong>Currency:</strong> All amounts are in LKR and calculated with high precision using BigDecimal.</li>
                </ul>
            </section>

            <section id="troubleshooting">
                <h2>4. Help and Support</h2>
                <p>If you encounter issues, try refreshing the page. If you cannot access certain features, it may be due to your account role (Staff vs Admin). Contact your administrator for assistance.</p>
            </section>
        </div>
    </main>
</body>
