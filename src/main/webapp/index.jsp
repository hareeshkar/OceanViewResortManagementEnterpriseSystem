    ...
    <head>
        ...
        <style>
            ...
            *::after {
            ...
            /* ─── CURSOR (only when JS confirms custom cursor is ready) ─── */
            body.cursor-ready {
            ...
            body.cursor-ready #c-dot,
            body.cursor-ready #c-ring {
                display: block;
            }
            ...
            /* fallback gradient when image missing — visible and atmospheric */
            .hero-img-fallback {
                position: absolute;
                inset: 0;
                z-index: 0;
                background: linear-gradient(160deg, #0c1220 0%, #162234 25%, #1a3040 45%, #0e2018 65%, #1c1508 85%, #0b0d10 100%);
            }
    ...
    <body>
        ...
        <header class="hero" id="home">
            ...
            <div class="hero-content">
                ...
                <p class="hero-sub">A fully managed coastal retreat — powered by a secure enterprise backend for
                    seamless reservations, billing, and staff operations.</p>
        ...
        <section class="section about" id="about" aria-labelledby="about-heading">
            <div class="about-inner">
                <div class="about-visual reveal">
                    <div class="about-visual-img">
                        ...
                        <svg viewBox="0 0 400 530" xmlns="http://www.w3.org/2000/svg" fill="none">
                            ...
                            <!-- Room outlines -->
                            <rect x="60" y="60" width="120" height="150" stroke="var(--accent)" stroke-width=".8"
                                opacity=".6" />
                            <rect x="220" y="60" width="120" height="150" stroke="var(--border)" stroke-width=".8"
                                opacity=".8" />
                            <rect x="60" y="250" width="280" height="200" stroke="var(--border)" stroke-width=".8"
                                opacity=".8" />
                            <!-- Room labels -->
                            <text x="120" y="142" fill="var(--accent)" font-size="8" font-family="var(--font-s)"
                                text-anchor="middle" opacity=".7">PRESIDENTIAL
                            </text>
                            <text x="120" y="154" fill="var(--accent)" font-size="8" font-family="var(--font-s)"
                                text-anchor="middle" opacity=".7">SUITE</text>
                            <text x="280" y="142" fill="var(--text-3)" font-size="8" font-family="var(--font-s)"
                                text-anchor="middle" opacity=".7">OCEAN DELUXE
                            </text>
                            <text x="200" y="356" fill="var(--text-3)" font-size="8" font-family="var(--font-s)"
                                text-anchor="middle" opacity=".7">STANDARD SINGLE
                            </text>
                            <!-- Measurement lines -->
                            <line x1="60" y1="230" x2="180" y2="230" stroke="var(--accent)" stroke-width=".4"
                                stroke-dasharray="3 2" opacity=".4" />
                            <line x1="60" y1="470" x2="340" y2="470" stroke="var(--border)" stroke-width=".4"
                                stroke-dasharray="3 2" opacity=".4" />
                            <!-- Compass rose -->
                            <circle cx="340" cy="470" r="18" stroke="var(--border)" stroke-width=".5" opacity=".5" />
                            <line x1="340" y1="455" x2="340" y2="485" stroke="var(--text-3)" stroke-width=".8"
                                opacity=".5" />
                            <line x1="325" y1="470" x2="355" y2="470" stroke="var(--text-3)" stroke-width=".8"
                                opacity=".5" />
                            <text x="340" y="451" fill="var(--accent)" font-size="7" text-anchor="middle"
                                opacity=".7">N</text>
                            <!-- Dotted ocean horizon -->
                            <path d="M40 510 Q100 505 160 510 T280 508 T360 510" stroke="var(--accent)"
                                stroke-width=".6" stroke-dasharray="2 3" opacity=".3" />
                            <text x="200" y="522" fill="var(--accent)" font-size="7" font-family="var(--font-s)"
                                text-anchor="middle" opacity=".4" letter-spacing="3">OCEAN FRONTAGE
                            </text>
                        </svg>
                    </div>
                ...
                <div class="about-text">
                    ...
                    <h2 id="about-heading" class="reveal reveal-delay-1">Where the ocean<br><em>meets precision.</em>
                    </h2>
                    <p class="about-desc reveal reveal-delay-2">OceanView Resort is a premium coastal property managed
                        entirely through this enterprise system. From the moment a guest arrives to the final invoice,
                        every workflow is handled with database-backed accuracy and role-based access control.</p>
                    <p class="about-desc reveal reveal-delay-2">Built on Java Servlets, MySQL, and JSP — the system
                        handles reservations, billing with automatic 5% service tax, room availability, and full audit
                        logging of every booking action.</p>

                    <div class="about-features">
                        <div class="feature-row reveal reveal-delay-2">
                            <div class="feature-icon">
                                <svg viewBox="0 0 40 40" fill="none">
                                    <circle cx="20" cy="20" r="19" stroke="var(--border)" stroke-width="0.5"
                                        stroke-dasharray="2 2" />
                                    <path d="M12 20 Q 20 5 28 20 T 40 20" stroke="var(--accent)" stroke-width="1.2"
                                        fill="none" class="svg-anim" />
                                    <rect x="16" y="16" width="8" height="8" transform="rotate(45 20 20)"
                                        stroke="var(--text)" stroke-width="1" fill="var(--bg)" />
                        ...
                        <div class="feature-row reveal reveal-delay-3">
                            <div class="feature-icon">
                                <svg viewBox="0 0 40 40" fill="none">
                                    <polygon points="20,4 36,12 36,28 20,36 4,28 4,12" stroke="var(--border)"
                                        stroke-width="0.5" opacity="0.6" />
                                    <path d="M 20 8 L 20 32" stroke="var(--accent)" stroke-width="1.2"
                                        stroke-dasharray="4 2" />
                                    <path d="M 10 16 L 30 16 M 10 24 L 30 24" stroke="var(--text)" stroke-width="1"
                                        opacity="0.5" />
                                    <circle cx="20" cy="20" r="4" fill="var(--bg)" stroke="var(--accent)"
                                        stroke-width="1.5" />
                                    <circle cx="20" cy="20" r="1" fill="var(--text)" />
                                </svg>
                            </div>
                        ...
                        <div class="feature-row reveal reveal-delay-4">
                            <div class="feature-icon">
                                <svg viewBox="0 0 40 40" fill="none">
                                    <path d="M 8 32 Q 15 15 20 10 T 32 8" stroke="var(--border)" stroke-width="1"
                                        fill="none" />
                                    <path d="M 8 32 Q 25 25 30 20 T 32 32" stroke="var(--accent)" stroke-width="1.2"
                                        fill="none" opacity="0.8" />
                                    <line x1="8" y1="32" x2="32" y2="32" stroke="var(--text)" stroke-width="0.5"
                                        stroke-dasharray="1 3" />
                                    <rect x="29" y="17" width="6" height="6" fill="var(--bg)" stroke="var(--accent)"
                                        stroke-width="1" />
                                </svg>
                            </div>
        ...
        <section class="section rooms" id="residences" aria-labelledby="rooms-heading">
            <div class="rooms-header reveal">
                ...
                <p>Three distinct categories — each managed live from the <code>ov_room_category</code> table in the
                    database.</p>
            </div>
            ...
            <div class="room-grid">
                ...
                <article class="room-card reveal">
                    ...
                    <div class="room-top">
                        ...
                        <p class="room-desc">A focused, well-appointed room for solo travelers. Clean lines, optimised
                            layout, and direct access to resort facilities. Rooms 101, 102 &amp; 103 fall under this
                            category.</p>
                    </div>
                ...
                <article class="room-card reveal reveal-delay-1">
                    ...
                    <div class="room-top">
                        ...
                        <p class="room-desc">Double occupancy room with a direct sea-facing view. Floor-to-ceiling
                            framing of the coastline. Rooms 201, 202 &amp; 203 — available status confirmed live from
                            the database.</p>
                    </div>
                    <div class="room-bottom">
                        <div class="room-features-list">
                ...
                <article class="room-card reveal reveal-delay-2">
                    ...
                    <div class="room-top">
                        ...
                        <p class="room-desc">The resort's flagship suite — Room 301. Full amenity package, panoramic
                            ocean exposure, and priority service. A single, exclusive property with unmediated horizon
                            views.</p>
                    </div>
                    <div class="room-bottom">
                        <div class="room-features-list">
        ...
        <section class="section availability" id="availability" aria-labelledby="avail-heading">
            <div class="avail-inner">
                <div class="avail-left">
                    ...
                    <p class="reveal reveal-delay-2">Select a room category and your stay dates. The system queries the
                        <code>ov_reservation</code> and <code>ov_accommodation</code> tables in real time via the
                        <code>/api/availability</code> endpoint to show live room status.
                    </p>
                </div>
        ...
        <section class="section how" id="how" aria-labelledby="how-heading">
            ...
            <h2 id="how-heading" class="reveal reveal-delay-1"
                style="font-size:clamp(2.5rem,5vw,5rem);margin-bottom:.5rem;">How a Booking<br><em>Works</em></h2>
            ...
            <div class="how-grid">
                <div class="how-step reveal">
                    ...
                    <div class="how-step-icon">
                        <svg viewBox="0 0 40 40" fill="none">
                            <circle cx="20" cy="20" r="14" stroke="var(--border)" stroke-width="0.5" />
                            <circle cx="20" cy="20" r="10" stroke="var(--accent)" stroke-width="1.2"
                                stroke-dasharray="2 4" />
                            <path d="M 20 6 L 20 10 M 20 30 L 20 34 M 6 20 L 10 20 M 30 20 L 34 20" stroke="var(--text)"
                                stroke-width="1.5" />
                            <circle cx="20" cy="20" r="3" fill="var(--bg)" stroke="var(--accent)" stroke-width="1.5" />
                        </svg>
                    </div>
                    <h3>Staff Login</h3>
                    <p>Authorised staff log in via the secure portal. Credentials are checked against SHA-256 salted
                        hashes in <code>ov_sys_account</code>. ADMIN and STAFF roles route to different dashboards.</p>
                </div>
                <div class="how-step reveal reveal-delay-1">
                    <span class="how-step-num">02</span>
                    <div class="how-step-icon">
                        <svg viewBox="0 0 40 40" fill="none">
                            <rect x="10" y="10" width="20" height="20" stroke="var(--border)" stroke-width="0.5"
                                transform="rotate(45 20 20)" />
                            <path d="M 12 20 Q 20 12 28 20 T 12 20" stroke="var(--accent)" stroke-width="1.2"
                                fill="none" opacity="0.8" />
                            <circle cx="20" cy="20" r="2" fill="var(--text)" />
                            <line x1="20" y1="2" x2="20" y2="8" stroke="var(--accent)" stroke-width="1" />
                            <line x1="20" y1="32" x2="20" y2="38" stroke="var(--accent)" stroke-width="1" />
                        </svg>
                    </div>
                    <h3>Check Availability</h3>
                    <p>Staff query rooms by category and dates. The <code>AvailabilityAPI</code> returns live JSON —
                        each room's status calculated against existing confirmed bookings in
                        <code>ov_reservation</code>.
                    </p>
                </div>
                <div class="how-step reveal reveal-delay-2">
                    ...
                    <div class="how-step-icon">
                        <svg viewBox="0 0 40 40" fill="none">
                            <path d="M 10 20 L 30 20" stroke="var(--border)" stroke-width="0.5"
                                stroke-dasharray="2 2" />
                            <polyline points="14,26 20,14 26,26" stroke="var(--accent)" stroke-width="1.5" fill="none"
                                stroke-linejoin="round" />
                            <rect x="18" y="24" width="4" height="4" fill="var(--bg)" stroke="var(--text)"
                                stroke-width="1" />
                            <circle cx="20" cy="14" r="1.5" fill="var(--accent)" />
                        </svg>
                    </div>
                    <h3>Create Reservation</h3>
                    <p>A booking reference like <code>OVR-A012</code> is auto-generated using UUID. Guest details, room,
                        and dates are saved to <code>ov_reservation</code>. A DB trigger logs the action to
                        <code>ov_audit_log</code>.
                    </p>
                </div>
                <div class="how-step reveal reveal-delay-3">
                    ...
                    <div class="how-step-icon">
                        <svg viewBox="0 0 40 40" fill="none">
                            <circle cx="20" cy="20" r="16" stroke="var(--border)" stroke-width="0.5"
                                stroke-dasharray="1 3" />
                            <path d="M 12 24 L 20 12 L 28 24 Z" stroke="var(--accent)" stroke-width="1.2" fill="none"
                                class="svg-anim" />
                            <path d="M 16 26 L 24 26" stroke="var(--text)" stroke-width="1" opacity="0.5" />
                        </svg>
                    </div>
                    <h3>Auto Invoice</h3>
                    <p>The <code>BillingService</code> immediately calculates room charges × nights + 5% service tax.
                        The invoice is written to <code>ov_billing_invoice</code> and is viewable as a printable
                        PDF-style page.</p>
                </div>
            </div>
        </section>
        ...
        <div class="tech-strip reveal" aria-label="Technology stack">
            ...
            <div class="tech-items">
                <div class="tech-pill">
                    <svg viewBox="0 0 40 40" fill="none">
                        <ellipse cx="20" cy="14" rx="12" ry="4" stroke="var(--text)" stroke-width="1.5"
                            stroke-dasharray="4 2" />
                        <ellipse cx="20" cy="20" rx="12" ry="4" stroke="var(--accent)" stroke-width="1.2"
                            opacity="0.6" />
                        <ellipse cx="20" cy="26" rx="12" ry="4" stroke="var(--text)" stroke-width="1.5"
                            stroke-dasharray="2 4" />
                        <line x1="8" y1="14" x2="8" y2="26" stroke="var(--border)" stroke-width="1" />
                        <line x1="32" y1="14" x2="32" y2="26" stroke="var(--border)" stroke-width="1" />
                    </svg>
                    MySQL / MariaDB
                </div>
                <div class="tech-pill">
                    <svg viewBox="0 0 40 40" fill="none">
                        <polygon points="20,6 34,26 6,26" stroke="var(--accent)" stroke-width="1.5"
                            stroke-linejoin="round" />
                        <polygon points="20,14 26,24 14,24" stroke="var(--text)" stroke-width="1" fill="none"
                            class="svg-anim" />
                        <circle cx="20" cy="6" r="1.5" fill="var(--bg)" stroke="var(--text)" stroke-width="1" />
                        <circle cx="6" cy="26" r="1.5" fill="var(--bg)" stroke="var(--text)" stroke-width="1" />
                        <circle cx="34" cy="26" r="1.5" fill="var(--bg)" stroke="var(--text)" stroke-width="1" />
                    </svg>
                    Java Servlets
                </div>
                <div class="tech-pill">
                    <svg viewBox="0 0 40 40" fill="none">
                        <rect x="8" y="14" width="24" height="12" rx="2" stroke="var(--text)" stroke-width="1"
                            stroke-dasharray="2 2" />
                        <path d="M 12 14 L 12 8 Q 20 4 28 8 L 28 14" stroke="var(--accent)" stroke-width="1.5"
                            fill="none" />
                        <path d="M 14 26 L 14 32 Q 20 36 26 32 L 26 26" stroke="var(--accent)" stroke-width="1.5"
                            fill="none" />
                    </svg>
                    JSP / Tomcat 9
                </div>
                <div class="tech-pill">
                    <svg viewBox="0 0 40 40" fill="none">
                        <path d="M 20 6 L 34 12 L 34 26 L 20 34 L 6 26 L 6 12 Z" stroke="var(--border)"
                            stroke-width="1" />
                        <path d="M 20 12 L 28 16 L 28 24 L 20 28 L 12 24 L 12 16 Z" stroke="var(--accent)"
                            stroke-width="1.5" opacity="0.8" />
                        <circle cx="20" cy="20" r="2" fill="var(--text)" />
                        <line x1="20" y1="6" x2="20" y2="12" stroke="var(--text)" stroke-width="0.5" />
                    </svg>
                    SHA-256 Auth
                </div>
                <div class="tech-pill">
                    <svg viewBox="0 0 40 40" fill="none">
                        <circle cx="20" cy="20" r="14" stroke="var(--text)" stroke-width="1" opacity="0.4" />
                        <path d="M 6 20 Q 20 6 34 20 T 6 20" stroke="var(--accent)" stroke-width="1.5" fill="none"
                            class="svg-anim" />
                        <circle cx="20" cy="20" r="4" fill="var(--bg)" stroke="var(--text)" stroke-width="1.5" />
                    </svg>
                    REST JSON API
                </div>
            </div>
        ...
        <section class="portal" id="portal" aria-labelledby="portal-heading">
            ...
            <div class="portal-inner">
                ...
                <p class="reveal reveal-delay-2">Authorised staff and administrators can log in to manage reservations,
                    view the financial ledger, check room availability, and generate invoices.</p>
        ...
        <footer>
            <div class="footer-top">
                <div class="footer-brand">
                    <h3>OceanView</h3>
                    <p>Enterprise Resort Management System — a full-stack Java EE application managing reservations,
                        billing, and room operations for a coastal resort property.</p>
                </div>
        ...
        <script>
            (function () {
                ...
                heroImg.src = '${pageContext.request.contextPath}/images/cinematic_resort_hero.png';
                ...
                if (availBtn) {
                    availBtn.addEventListener('click', async () => {
                        ...
                        try {
                            ...
                            let html = '';
                            rooms.forEach(r => {
                                const badgeClass = r.status === 'AVAILABLE' ? 'badge-available' : 'badge-occupied';
                                html += '<div class="avail-room-item">' +
                                    '<div>' +
                                    ...
                                    '</div>' +
                                    '<span class="avail-status-badge ' + badgeClass + '">' + r.status + '</span>' +
                                    '</div>';
                            });
                            out.innerHTML = html;
                        } catch (err) {
